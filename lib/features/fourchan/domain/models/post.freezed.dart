...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Post&&(identical(other.id, id) || other.id == id)&&(identical(other.boardId, boardId) || other.boardId == boardId)&&(identical(other.threadId, threadId) || other.threadId == threadId)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.name, name) || other.name == name)&&(identical(other.tripcode, tripcode) || other.tripcode == tripcode)&&(identical(other.subject, subject) || other.subject == subject)&&(identical(other.comment, comment) || other.comment == comment)&&(identical(other.media, media) || other.media == media)&&const DeepCollectionEquality().equals(other.referencedPosts, referencedPosts)&&(identical(other.isOp, isOp) || other.isOp == isOp)&&(identical(other.posterId, posterId) || other.posterId == posterId)&&(identical(other.countryCode, countryCode) || other.countryCode == countryCode)&&(identical(other.countryName, countryName) || other.countryName == countryName)&&(identical(other.boardFlag, boardFlag) || other.boardFlag == boardFlag)&&(identical(other.flagName, flagName) || other.flagName == flagName));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,boardId,threadId,timestamp,name,tripcode,subject,comment,media,const DeepCollectionEquality().hash(referencedPosts),isOp,posterId,countryCode,countryName,boardFlag,flagName);

@override
String toString() {
  return 'Post(id: $id, boardId: $boardId, threadId: $threadId, timestamp: $timestamp, name: $name, tripcode: $tripcode, subject: $subject, comment: $comment, media: $media, referencedPosts: $referencedPosts, isOp: $isOp, posterId: $posterId, countryCode: $countryCode, countryName: $countryName, boardFlag: $boardFlag, flagName: $flagName)';
}
...
@useResult
$Res call({
 String id, String boardId, String? threadId, DateTime timestamp, String? name, String? tripcode, String? subject, String comment, Media? media, List<String> referencedPosts, bool isOp, String? posterId, String? countryCode, String? countryName, String? boardFlag, String? flagName
});
...
as bool,posterId: freezed == posterId ? _self.posterId : posterId // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,boardId,threadId,timestamp,name,tripcode,subject,comment,media,const DeepCollectionEquality().hash(_referencedPosts),isOp,posterId,countryCode,countryName,boardFlag,flagName);
